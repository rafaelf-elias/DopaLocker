...
function renderHeader() {
    const html = `
        <a href="DopaLocker/index.html"><h1>DopaLocker Web</h1></a>
        <nav class="nav">
            <div class="navMobile">
                <i class="fas fa-bars icon"></i>
            </div>
            <ul class="navList">
                <li class="navItem"><a href="DopaLocker/daily.html">Uso Diário</a></li>
                <li class="navItem"><a href="DopaLocker/weekly.html">Uso Semanal</a></li>
                <li class="navItem"><a href="DopaLocker/config.html">Configurações</a></li>
            </ul>
        </nav>
    `;
